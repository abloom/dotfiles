...
plugins=(git history-substring-search gem osx rails rake ssh-agent bundler npm colored-man screen docker vagrant rbenv scala sbt bower docker-compose mvn go golang tmux)
