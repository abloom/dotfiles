...
plugins=(git history-substring-search gem osx rake ssh-agent bundler npm colored-man-pages screen docker vagrant scala sbt bower docker-compose mvn go golang gpg-agent tmux rbenv)
